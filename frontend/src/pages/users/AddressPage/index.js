      ...
      <div className="section">
        ...
        <div className="container">
          <div className="row">
              ...
              <div className="address-detail">
                ...
                <div className="detail-list">
                  ...
                  <ul className="list-unstyled list-icon">
                    ...
                    <li>
                      <a href="#">
                        <i className="bi bi-geo-alt"></i> 285 Doi Can, Ba Dinh,
                        Ha Noi
                      </a>
                    </li>
                  </ul>
                ...
                <div className="social-links">
                  ...
                  <ul className="d-flex list-unstyled">
                    ...
                    <li>
                      <a href="#" className="bi bi-pinterest"></a>
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div className="col-md-6">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3723.9232491378366!2d105.81641017449773!3d21.03575678061532!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3135ab0d127a01e7%3A0xab069cd4eaa76ff2!2zMjg1IFAuIMSQ4buZaSBD4bqlbiwgTGnhu4V1IEdpYWksIEJhIMSQw6xuaCwgSMOgIE7hu5lpIDEwMDAwMCwgVmnhu4d0IE5hbQ!5e0!3m2!1svi!2s!4v1722021534378!5m2!1svi!2s"
                width="600"
                height="450"
                allowfullscreen=""
                loading="lazy"
